            ...
            {cart.length === 0 ? (
              ...
              cart.map((item, index) => (
                <div key={index} className="flex items-center gap-3 bg-neutral-700 rounded-xl p-3">
                  <img src={item.image} alt={item.name} className="w-10 h-10 object-cover rounded-lg shrink-0" onError={(e) => { e.target.src = 'https://placehold.co/40x40/1a1a1a/666?text=No' }} />
