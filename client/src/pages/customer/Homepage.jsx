      ...
      <div className="relative min-h-screen flex items-center overflow-hidden">
        {bestSellers.length > 0 ? (
          <div
            ...
            style={{
              backgroundImage: `url(http://localhost:5000/uploads/${bestSellers[heroIndex]?.image})`,
          ...
          <div className="relative">
            <div className="flex items-center justify-center gap-6">
              {featuredProducts.length > 1 && (
                ...
                >
                  <div className="w-48 h-48 rounded-full overflow-hidden border-2 border-orange-400 shadow-lg">
                    <img
                      src={`http://localhost:5000/uploads/${featuredProducts[getRelativeIndex(-1)].image}`}
                      alt=""
              ...
              <div className="flex items-center gap-12 shrink-0">
                ...
                >
                  <img
                    src={`http://localhost:5000/uploads/${currentProduct.image}`}
